      ...
      <div className="bg-white shadow-sm border-b mb-6">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Comprehensive Digital Library</h1>
              <p className="text-gray-600 mt-1">Advanced Digital & Physical Resource Management System</p>
            </div>
