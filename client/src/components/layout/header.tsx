...
export default function Header({ onMenuClick, isMobile = false }: HeaderProps) {
  ...
  return (
    <header className="fixed top-0 right-0 left-0 lg:left-0 bg-white border-b border-gray-200 z-40">
      <div className="flex items-center justify-between px-3 lg:px-6 py-3 h-[56px]" style={{backgroundColor: '#ffffff', borderBottom: '1px solid #e5e7eb'}}>
        {/* Mobile Menu Button */}
        <button 
        ...
        <div className="flex-1 flex items-center justify-start">
          ...
          >
            <img src="/abc-logo-optimized.png" alt="ABC UMS ERP" className="h-8 w-8 lg:h-9 lg:w-9 drop-shadow-md" />
            <div className="flex flex-col">
              <h1 className="text-lg lg:text-xl font-semibold" style={{color: '#1f2937', margin: '0'}}>ABC UMS ERP</h1>
        ...
        <div className="flex items-center space-x-2 lg:space-x-4">
          {/* Role Badge */}
          <Badge className="bg-blue-600 text-white px-2 lg:px-3 py-1 text-xs lg:text-sm font-medium">
            {currentRole}
          </Badge>
